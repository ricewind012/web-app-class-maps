...
function h(e, t) {
	return {
		async queryFn() {
			let n = await l.GetProfileItemsEquipped(e, {
				language: r.LANGUAGE,
				steamid: t,
			});
			if (n.GetEResult() != 1)
				throw (
					...
					new a(n.GetEResult(), `Failed to load equipped profile items`)
				);
...
var _ = n();
function v(e) {
	let { rgSources: t, onIncrementalError: n, alt: r, ...i } = e,
		[a, o] = (0, d.useState)(0),
		s = t[a];
	return (0, _.jsx)(`img`, {
		alt: r,
...
function j(e) {
	let { profileItem: t, className: n, bDisableAnimation: i, ...a } = e;
	if (!t || !t.image_small || t.image_small.length == 0) return null;
	let o = i ? t.image_large : t.image_small;
	return (
		(o ||= t.image_small),
		o.startsWith(`https://`) || (o = r.MEDIA_CDN_COMMUNITY_URL + `images/` + o),
		(0, _.jsx)(`div`, {
			className: (0, y.default)(O, n),
			...a,
...
function M(e) {
	let {
		...
		s = u(t.public_data?.sha_digest_avatar, a);
	return (
		n?.image_small?.length &&
			(s = r.MEDIA_CDN_COMMUNITY_URL + `images/` + n.image_small),
		(0, _.jsx)(A, {
			avatarURL: s,
			isAwayOrSnooze:
...
function N(e, t) {
	let [n, r] = (0, d.useState)(e !== `None`);
	return (
		(0, d.useEffect)(() => {
			if ((r(e !== `None`), e === `None` || e === `Infinite`)) return;
			let n;
			switch (e) {
				case `Short`:
					n = 2500;
...
function P(e) {
	let {
		...
		[o, s] = (0, d.useState)(!1),
		c = N(t, o),
		l = g(a.playerLinkDetails.public_data.steamid);
	return (0, _.jsx)(`div`, {
		children: (0, _.jsx)(M, {
			...a,
			animatedAvatar: c ? l.data?.animated_avatar : void 0,
			children: (0, _.jsx)(j, {
				bDisableAnimation: r && !c,
				profileItem: l.data?.avatar_frame,
			}),
		}),
		className: i,
		onMouseEnter: () => s(!0),
...
export { g as r, M as n, P as t };
//# sourceMappingURL=DgqLPeZP.js.map
