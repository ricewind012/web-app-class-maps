...
(async () => {
	window.parsedModules = [
		...
		const exists = (c: string) => keys.some((e) => e === c);
		const mod: ClassModule = JSON.parse(e[1].replace(/(\w+):/g, '"$1":'));
...
var exportedModules: ExportedModuleMap = [
	...
	["familysharedcomponents", (e) => e.FamilyMemberRow],
	...
	["gamepaduiappoverlayvirtualmenucontainer", (e) => e.RadialMenuSegmentLabel],
	["gamepaduisvglibrary", (e) => e.WifiBar1 && !e.Checkbox],
	...
	["mainmenu", (e) => e.IsVirtualKeyboardShown && !e.CurrentGameLogo],
	...
	["presenterpopup", (e) => e.SpeakerInfoInner],
	...
	["sharedsvglibrary", (e) => e.HasHorizontalDirection],
